.. |PackageName| replace:: pyEDAA.Launcher
      ...
      .. tab-set::
         ...
         .. tab-item:: Minimal installation
            ...
            .. code-block:: bash
               ...
               # Basic pyEDAA.Launcher package
               pip3 install pyEDAA.Launcher

               # Alternatively
               python3 -m pip install pyEDAA.Launcher
         ...
         .. tab-item:: With Documentation Dependencies
            ...
            .. code-block:: bash
               ...
               pip3 install pyEDAA.Launcher[doc]

               # Alternatively
               python3 -m pip install pyEDAA.Launcher[doc]
         ...
         .. tab-item:: With Unit Testing Dependencies
            ...
            .. code-block:: bash
               ...
               pip3 install pyEDAA.Launcher[test]

               # Alternatively
               python3 -m pip install pyEDAA.Launcher[test]
         ...
         .. tab-item:: All Developer Dependencies
            ...
            .. code-block:: bash
               ...
               pip3 install pyEDAA.Launcher[all]

               # Alternatively
               python3 -m pip install pyEDAA.Launcher[all]
      ...
      .. tab-set::
         ...
         .. tab-item:: Minimal installation
            ...
            .. code-block:: powershell
               ...
               # Basic pyEDAA.Launcher package
               pip install pyEDAA.Launcher

               # Alternatively
               py -m pip install pyEDAA.Launcher
         ...
         .. tab-item:: With Documentation Dependencies
            ...
            .. code-block:: powershell
               ...
               # Install with dependencies to generate documentation
               pip install pyEDAA.Launcher[doc]

               # Alternatively
               py -m pip install pyEDAA.Launcher[doc]
         ...
         .. tab-item:: With Unit Testing Dependencies
            ...
            .. code-block:: powershell
               ...
               # Install with dependencies to run unit tests
               pip install pyEDAA.Launcher[test]

               # Alternatively
               py -m pip install pyEDAA.Launcher[test]
         ...
         .. tab-item:: All Developer Dependencies
            ...
            .. code-block:: powershell
               ...
               # Install with all developer dependencies
               pip install pyEDAA.Launcher[all]

               # Alternatively
               py -m pip install pyEDAA.Launcher[all]
...
.. tab-set::
   ...
   .. tab-item:: Linux/macOS
      ...
      .. code-block:: bash
         ...
         # Update pyEDAA.Launcher
         pip3 install -U pyEDAA.Launcher

         # Alternatively
         python3 -m pip install -U pyEDAA.Launcher
   ...
   .. tab-item:: Windows
      ...
      .. code-block:: powershell
         ...
         # Update pyEDAA.Launcher
         pip install -U pyEDAA.Launcher

         # Alternatively
         py -m pip install -U pyEDAA.Launcher
...
.. tab-set::
   ...
   .. tab-item:: Linux/macOS
      ...
      .. code-block:: bash
         ...
         # Uninstall pyEDAA.Launcher
         pip3 uninstall pyEDAA.Launcher

         # Alternatively
         python3 -m pip uninstall pyEDAA.Launcher
   ...
   .. tab-item:: Windows
      ...
      .. code-block:: powershell
         ...
         # Uninstall pyEDAA.Launcher
         pip uninstall pyEDAA.Launcher

         # Alternatively
         py -m pip uninstall pyEDAA.Launcher
...
.. tab-set::
   ...
   .. tab-item:: Linux/macOS
      ...
      .. code-block:: bash
         ...
         python3 -m pip uninstall -y pyEDAA.Launcher

         # Install from wheel
         python3 -m pip install ./dist/pyEDAA.Launcher-0.3.0-py3-none-any.whl
   ...
   .. tab-item:: Windows
      ...
      .. code-block:: powershell
         ...
         # Uninstall the old package
         py -m pip uninstall -y pyEDAA.Launcher

         # Install from wheel
         py -m pip install .\dist\pyEDAA.Launcher-0.3.0-py3-none-any.whl
